...
Nhóm tiến hành kiểm thử trực tiếp trên ứng dụng để xác nhận từng chức năng hoạt động đúng như thiết kế. Người kiểm thử đóng vai trò người dùng thực, thao tác trên màn hình theo từng kịch bản cụ thể và đối chiếu kết quả thu được với kết quả mong đợi. Các kịch bản bao gồm cả luồng sử dụng thông thường lẫn các trường hợp nhập sai, bỏ trống, hay thực hiện thao tác ngoài phạm vi quyền hạn -- nhằm đảm bảo ứng dụng phản hồi đúng trong mọi tình huống.

Tổng cộng \textbf{308 kịch bản kiểm thử} được thực hiện trên toàn bộ \textbf{26 chức năng} của hệ thống, bao phủ đầy đủ các nhóm tính năng: đăng nhập và đăng ký tài khoản, quản lý 6 lọ tài chính, ghi nhận và lên lịch giao dịch, cảnh báo chi tiêu, trợ lý AI, quản lý học bổng, theo dõi bảng điểm và thông báo. \textbf{Tất cả 308 kịch bản đều đạt -- tỉ lệ thành công 100\%}, xác nhận hệ thống Student360 đã sẵn sàng về mặt chức năng để đưa vào sử dụng thực tế.
...
\subsection{Đóng góp thực tiễn của sản phẩm}
