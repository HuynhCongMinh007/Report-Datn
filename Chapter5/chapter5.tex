...
\begin{table}[H]
    ...
    \begin{tabular}{|L{3.2cm}|C{1.8cm}|C{1.8cm}|L{2.2cm}|L{3.5cm}|}
        ...
        Hàng đợi thông báo (BullMQ) & < 10ms & < 20ms & \textbf{1.22ms} (TB)\newline\textbf{1.48ms} (p95) & Kiểm thử tải: 1.000 request, concurrency = 10 \\ \hline
    \end{tabular}
...
\begin{enumerate}
    ...
    \item \textbf{Hiệu năng vận hành thực tế:} Hệ thống đáp ứng tốt các mục tiêu hiệu năng đề ra (SLO). Độ trễ xử lý các tác vụ cơ bản ở mức rất thấp (dưới 100ms đối với thao tác đọc dữ liệu), thời gian suy luận phân loại của LLM ổn định trong khoảng 1.92 giây.
