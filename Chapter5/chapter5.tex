...
\textit{Phương pháp đo:} Bộ dữ liệu kiểm thử gồm 30 hồ sơ sinh viên so khớp với 150 học bổng, mỗi hồ sơ được gán sẵn 12 học bổng thực sự phù hợp làm đáp án đúng để đối chiếu. Kết quả dưới đây đo trên chính hàm mà hệ thống dùng để trả danh sách gợi ý hiển thị cho người dùng (gồm bước lọc theo trường/ngành, sau đó sắp xếp theo điểm tổng hợp giữa độ liên quan chủ đề, mức phù hợp GPA và giá trị học bổng), thực thi cục bộ, không qua mạng hay gọi LLM, đảm bảo kết quả tất định và có thể tái lập.

Bảng~\ref{tab:scholarship-matching} tổng hợp kết quả, tính trung bình qua toàn bộ 30 hồ sơ.
...
\begin{table}[H]
    ...
    \begin{tabular}{|L{9.0cm}|C{3.0cm}|}
        ...
        Tỷ lệ hồ sơ có học bổng đúng ở vị trí gợi ý đầu tiên & \textbf{83.3\%} \\ \hline
        Tỷ lệ hồ sơ tìm thấy ít nhất 1 học bổng đúng trong 3 gợi ý đầu & \textbf{96.7\%} \\ \hline
        Tỷ lệ hồ sơ tìm thấy ít nhất 1 học bổng đúng trong 5 gợi ý đầu & \textbf{100.0\%} \\ \hline
        Số học bổng đúng trung bình xuất hiện trong 5 gợi ý đầu (trên tổng 12 học bổng đúng/hồ sơ) & \textbf{3.97/5} \\ \hline
        Tỷ lệ học bổng đúng không bị lọc nhầm ở bước lọc trường/ngành & \textbf{100.0\%} \\ \hline
    \end{tabular}
    \caption{Kết quả đánh giá gợi ý học bổng (N=30 hồ sơ, 150 học bổng, 12 học bổng đúng/hồ sơ)}
    \label{tab:scholarship-matching}
\end{table}

Bước lọc theo trường/ngành không loại nhầm bất kỳ học bổng phù hợp nào (100\%). Với 83.3\% hồ sơ, học bổng gợi ý đầu tiên đã là một lựa chọn đúng; 96.7\% hồ sơ tìm thấy ít nhất một học bổng phù hợp ngay trong 3 gợi ý đầu tiên và \textbf{100\% hồ sơ} đều tìm thấy học bổng thực sự phù hợp ngay trong 5 gợi ý đầu tiên -- tức là sinh viên gần như luôn thấy được một học bổng đúng mà không cần cuộn xem nhiều. Trung bình mỗi hồ sơ có 3.97 học bổng đúng xuất hiện trong 5 gợi ý đầu, cho thấy danh sách gợi ý không chỉ đúng ở vị trí đầu mà còn bao phủ tốt phần lớn các lựa chọn phù hợp khác.
