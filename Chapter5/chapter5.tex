...
Nhóm phát triển đã tiến hành kiểm thử hộp đen (Black-box testing) đối với các giao diện người dùng trên phân hệ Mobile App và Webadmin. Để tiện truy vết với đặc tả chức năng ở Chương 3, Mục~3.7, mỗi nhóm ca kiểm thử được gán một mã dạng FUNC-TCxx và ánh xạ về mã use case tương ứng như trong Bảng~\ref{tab:func-test-results}. 100\% các ca kiểm thử chức năng nghiệp vụ cơ bản trên giao diện đều hoạt động ổn định, đạt yêu cầu đề ra của bài toán.
