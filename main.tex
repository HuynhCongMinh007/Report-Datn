...
3  & CRUD   & Tạo - Đọc - Cập nhật - Xóa (Create, Read, Update, Delete) \\ \hline
4  & DB     & Cơ sở dữ liệu (Database) \\ \hline
5  & ERD    & Sơ đồ thực thể liên kết (Entity Relationship Diagram) \\ \hline
6  & FCM    & Dịch vụ thông báo đám mây của Firebase (Firebase Cloud Messaging) \\ \hline
7  & GPA    & Điểm trung bình tích lũy (Grade Point Average) \\ \hline
8  & HTTP   & Giao thức truyền siêu văn bản (HyperText Transfer Protocol) \\ \hline
9  & JSON   & Ký hiệu đối tượng JavaScript (JavaScript Object Notation) \\ \hline
10 & JWT    & Mã thông báo JSON Web (JSON Web Token) \\ \hline
11 & LLM    & Mô hình ngôn ngữ lớn (Large Language Model) \\ \hline
12 & NLP    & Xử lý ngôn ngữ tự nhiên (Natural Language Processing) \\ \hline
13 & RBAC   & Kiểm soát truy cập dựa trên vai trò (Role-Based Access Control) \\ \hline
14 & REST   & Chuyển trạng thái đại diện (Representational State Transfer) \\ \hline
15 & SSE    & Sự kiện gửi từ máy chủ (Server-Sent Events) \\ \hline
16 & TTL    & Thời gian sống của bộ nhớ đệm (Time-To-Live) \\ \hline
17 & UI     & Giao diện người dùng (User Interface) \\ \hline
18 & UUID   & Định danh duy nhất toàn cầu (Universally Unique Identifier) \\ \hline
19 & UX     & Trải nghiệm người dùng (User Experience) \\ \hline
\end{longtable}
