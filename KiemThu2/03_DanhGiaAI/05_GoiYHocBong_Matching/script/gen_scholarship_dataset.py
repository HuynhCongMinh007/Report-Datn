...
def gen_profiles():
    profiles = []
    idx = 1
    # 3 profiles per major (10 majors x 3 = 30), cycling universities so each major sees
    # a spread of universities (not just 1:1), and varying GPA.
    gpa_cycle = [2.6, 2.9, 3.1, 3.3, 3.5, 3.7, 3.9]
