...
\begin{itemize}
    ...
    \item \textbf{Công nghệ cơ sở dữ liệu:} PostgreSQL 17 (image \texttt{pgvector/pgvector:pg17} khi phát triển cục bộ, \texttt{postgres:17-alpine} khi triển khai) \cite{postgresql-docs}, Redis 8 khi phát triển cục bộ (\texttt{redis:8-alpine}) và Redis 7 khi triển khai (\texttt{redis:7-alpine}) \cite{redis-docs} (làm cache và message broker cho BullMQ \cite{bullmq-docs}).
...
\begin{figure}[H]
    ...
    \IfFileExists{Images/chapter4/mobile/add-transaction.png}{%
        \includegraphics[width=0.48\textwidth]{Images/chapter4/mobile/add-transaction.png}%
    }{%
...
\begin{figure}[H]
    ...
    \IfFileExists{Images/chapter4/mobile/auto-transfer.png}{%
        \includegraphics[width=0.48\textwidth]{Images/chapter4/mobile/auto-transfer.png}%
    }{%
...
\begin{figure}[H]
    ...
    \IfFileExists{Images/chapter4/mobile/financial-report.png}{%
        \includegraphics[width=0.48\textwidth]{Images/chapter4/mobile/financial-report.png}%
    }{%
