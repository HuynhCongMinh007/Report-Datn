...
Bên cạnh việc đánh giá nội tại, nhóm phát triển cũng đối chiếu các nhóm chức năng của Student360 với ba ứng dụng quản lý tài chính phổ biến hiện nay là Money Lover, Sổ Thu Chi MISA và Spendee. Kết quả đối chiếu được trình bày trong Bảng~\ref{tab:comparison-finance} (nhóm tính năng tài chính cốt lõi -- so sánh cùng phạm vi) và Bảng~\ref{tab:comparison-education} (nhóm tính năng học bổng và học thuật -- thể hiện sự khác biệt hóa về định vị sản phẩm); phần phân tích chi tiết về định vị sản phẩm được trình bày tại Chương 7.
