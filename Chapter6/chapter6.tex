...
\begin{figure}[H]
    ...
    \IfFileExists{Images/chapter4/webadmin/sponsor-create-scholarship.png}{%
        \includegraphics[width=0.6\textwidth]{Images/chapter4/webadmin/sponsor-create-scholarship.png}%
    }{%
...
\begin{figure}[H]
    ...
    \IfFileExists{Images/chapter4/webadmin/sponsor-application-review.png}{%
        \includegraphics[width=0.6\textwidth]{Images/chapter4/webadmin/sponsor-application-review.png}%
    }{%
