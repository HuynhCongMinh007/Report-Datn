...
\begin{enumerate}
    ...
    \item \textbf{Hiệu quả tích hợp trí tuệ nhân tạo (AI):} Hệ trợ lý ảo và bộ phân loại giao dịch tự động hoạt động tốt với ngôn ngữ tự nhiên viết tay của sinh viên Việt Nam. Qua bộ kiểm thử tự động, tái lập được trên dữ liệu cố định, hệ thống đạt độ chính xác phân loại giao dịch \textbf{90.0\%} trên 90 mẫu thử nghiệm (Macro-F1 89.5\%) và gợi ý đúng học bổng phù hợp nhất ở vị trí đầu tiên cho \textbf{12/12 hồ sơ thử nghiệm} (N=12 hồ sơ $\times$ 15 học bổng) -- xem chi tiết phương pháp và giới hạn mẫu ở mục 6.4. Việc tích hợp stream SSE giúp cải thiện đáng kể trải nghiệm chờ đợi phản hồi của LLM so với mô hình chờ toàn bộ câu trả lời.
...
\begin{table}[H]
    ...
    \begin{tabular}{|L{4cm}|L{9cm}|}
        ...
        Backend (commit) & \texttt{b3e668a0} (nhánh \texttt{staging}, repo \texttt{backend}) + 1 thay đổi cục bộ chưa commit tại \texttt{notification.processor.ts} (cấu hình \texttt{concurrency=10}, xem mục 6.5) \\ \hline
