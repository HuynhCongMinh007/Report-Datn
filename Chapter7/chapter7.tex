...
\textbf{Nhóm 1: Các tính năng Tài chính tương đồng (so sánh cùng phạm vi)} -- kết quả đối chiếu chi tiết được trình bày tại Bảng~\ref{tab:comparison-finance}, Chương 6.
...
\textbf{Nhóm 2: Sự khác biệt hóa về Tính năng Học bổng và Học thuật} -- kết quả đối chiếu chi tiết được trình bày tại Bảng~\ref{tab:comparison-education}, Chương 6.
...
\begin{enumerate}
    ...
    \item \textbf{Quy mô benchmark định lượng cho các thành phần AI và hạ tầng còn nhỏ:} Bộ dữ liệu gán nhãn cố định và script đo lường tự động, tái lập được đã được xây dựng cho phân loại giao dịch, gợi ý học bổng và khả năng chịu tải hàng đợi thông báo đẩy FCM (xem Bảng~\ref{tab:ai-classify-eval} và Bảng~\ref{tab:fcm-latency-eval}, Chương 6), nhưng quy mô mẫu hiện tại (90 giao dịch, 12 hồ sơ học bổng, 1.000 request tải) còn nhỏ so với dữ liệu thực tế; cần mở rộng bộ dữ liệu gán nhãn và chạy lại benchmark định kỳ khi hệ thống có thêm người dùng thật.
\end{enumerate}
