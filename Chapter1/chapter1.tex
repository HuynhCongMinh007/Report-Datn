...
\begin{itemize}
    \item Nghiên cứu cơ sở lý thuyết và hiện thực hóa mô hình quản lý tài chính cá nhân "6 cái lọ" trên ứng dụng di động, giúp sinh viên thiết lập và duy trì thói quen chi tiêu khoa học.
...
\begin{itemize}
    ...
    \item \textbf{Về mặt công nghệ:} Phát triển hệ thống đa dịch vụ (Monorepo) tích hợp: Backend (NestJS, TypeScript), AI Service (FastAPI, Python, LangChain, Google Gemini API), Mobile App (Expo React Native), và Web Portal Admin (React JS, Material UI).
