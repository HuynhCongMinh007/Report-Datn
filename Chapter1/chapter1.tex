...
Để đảm bảo các mục tiêu nêu trên được hiện thực hóa và có khả năng đánh giá thực nghiệm rõ ràng, nhóm đề tài thiết lập bảng chỉ số hiệu năng cốt lõi (KPI) và ngưỡng đạt yêu cầu như mô tả trong Bảng~\ref{tab:kpi-he-thong}.

\begin{table}[H]
\centering
\caption{Bảng chỉ số hiệu năng cốt lõi (KPI) và ngưỡng đạt yêu cầu của hệ thống}
\label{tab:kpi-he-thong}
\begin{tabular}{|L{3cm}|L{4.2cm}|L{3.2cm}|L{3.2cm}|C{1.8cm}|}
\hline
\textbf{Phân hệ / Mục tiêu} & \textbf{Chỉ số KPI chính} & \textbf{Ngưỡng đạt yêu cầu} & \textbf{Phương pháp đo lường} & \textbf{Chương kiểm chứng} \\ \hline
Quản lý tài chính & Độ chính xác phân loại giao dịch bằng AI & $\ge 90\%$ & Tập kiểm thử gồm 200 mô tả giao dịch mẫu & Chương 5 \\ \hline
Trợ lý ảo AI & Độ trễ phản hồi ký tự đầu tiên (Time to First Token) & $< 1.5$ giây (áp dụng stream SSE) & Đo lường qua các request kiểm thử thực tế & Chương 5 \\ \hline
Học bổng trực tuyến & Tỷ lệ hoàn thành nộp hồ sơ không phát sinh lỗi & $\ge 98\%$ & Kiểm thử tải (Load testing) và kiểm thử E2E & Chương 5 \\ \hline
Quản lý học thuật & Độ chính xác trong tính toán GPA và tiến độ tích lũy tín chỉ & $100\%$ (đảm bảo tính nhất quán và không sai số) & Đối chiếu tự động công thức tính toán với bảng điểm thực tế & Chương 5 \\ \hline
Thông báo đẩy & Tỷ lệ gửi thông báo FCM thành công đến thiết bị đích & $\ge 95\%$ & Thống kê từ nhật ký hệ thống gửi tin qua BullMQ/Redis & Chương 5 \\ \hline
\end{tabular}
\end{table}
