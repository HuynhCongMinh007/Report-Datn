...
\begin{itemize}
    ...
    \item Phát triển hệ thống quản trị Webadmin giúp các nhà quản lý trường học dễ dàng đồng bộ cơ sở dữ liệu học thuật (Trường, Khoa, Môn) và hỗ trợ nhà tài trợ kiểm soát quy trình xét duyệt học bổng.
\end{itemize}
...
\begin{itemize}
    ...
    \item Sử dụng các độ đo tương đồng văn bản (như Jaccard, Token Overlap, n-grams) kết hợp cùng mô hình ngôn ngữ lớn (LLM) để hiểu ý định tìm kiếm của sinh viên, từ đó tự động truy vấn, tính toán điểm số và đề xuất các cơ hội phù hợp nhất cho từng cá nhân, giảm thiểu thời gian tìm kiếm thủ công.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Về hỗ trợ học tập:} Xây dựng cổng thông tin học bổng tích hợp bộ công cụ so khớp thông minh, giúp rút ngắn khoảng cách giữa sinh viên xuất sắc và các nguồn quỹ tài trợ xã hội, đồng thời cung cấp giải pháp duyệt hồ sơ trực quan, hiệu quả.
\end{itemize}